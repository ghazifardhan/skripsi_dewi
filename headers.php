...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Admin_VS</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="trx _kontraktor.php"><i class="fa fa-circle-o"></i> Kontraktor</a></li>
            <li><a href="trx.php"><i class="fa fa-circle-o"></i>Konsultan</a></li>
            <li><a href="tampilan_trx.php"><i class="fa fa-circle-o"></i>Hasil_Transaksi_konsultan</a></li>
            <li><a href="tampilan_trx_kontraktor.php"><i class="fa fa-circle-o"></i>Hasil_Transaksi_kontraktor</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        PT. Primer Eka Properti
        <small>Victoria Square</small>
      </h1>
      <ol class="breadcrumb">
